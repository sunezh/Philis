...
### General Breakdown (see notes/book for details)

* Placement Considerations
  * Transistor pairs and some passive devices
    * Symmetry
      * Common centroid or 1D cross coupling for gradient
    * Matching
    * Orientation
      * Current mirror 
  * Dummy device placement around arrays
  * Guard ring
  * Multi-finger/folding structures
  * STI fingers
  * n-well enclose (well proximity effects)
  * Grid snap
* Routing Considerations
  * Interconnect capacitance, resistance, electromigration
    * EOL and PRL spacing
  * Via and contact resistance
  * Symmetry
    * Dummy wires
  * Shielding for sensitive wire
    * Potentially multi-layer
  * Antenna effect
  * Self and mutual capacitance
    * Simulation concern
  * Self inductance mitigation
  * Mutual inductance mitigation
